...
init-base()
{
   sudo pacman -S firefox gdm cheese evince file-roller gnome-calculator gnome-disk-utility gnome-keyring gnome-user-share gvfs nautilus sushi mtpfs gvfs-mtp gvfs-gphoto2 git nvidia-open nvidia-prime libva-nvidia-driver bluez android-tools xdg-utils qt5-wayland qt6-wayland gnome-calendar wl-mirror
